          ...
          <?php if($this->session->userdata('admin_userid')) : ?>
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li <?php if( isset($page_section) && $page_section=='performance') : ?>class="active"<?php endif;?>><a href="<?php echo site_url('manage/performance'); ?>">Manage supplier performance</a></li>
